        ...
        <div class="page-title clearfix">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h6><span class="page-active">Admin Login</span></h6>
                </div>
            </div>
        </div>
    </div>
...
<div id="login-box-name" style="margin-top:20px;">User Name:</div><div id="login-box-field" style="margin-top:20px;"><input name="username" id="emailid" class="form-login" title="Username" value="" size="30" maxlength="2048" type="text" /><div style="color:White;" id="err1"></div></div>
...
document.getElementById("check").value=document.getElementById("check").defaultValue;
     ...
     <script type="text/javascript">
         function forget() {
             {
                 alert("Please Contact Your 9026419991");
             }
