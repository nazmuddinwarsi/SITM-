<%@ Page Language="C#" AutoEventWireup="true" CodeFile="marksheet_details.aspx.cs" Inherits="marksheet_details" %>
           ...
           <center><h4 class="text-theme-colored mt-0 pt-5 col-md-push-2"> Certificate Verifcation</h4></center>  
               <asp:Panel ID="pnlContents" runat="server">
                ...
                <div  class="col-md-12  col-md-push-1" style="position: relative;">
                     ...
                     <img src="images/MarksheetVarification.jpg" style=" width:930px; height:1325px;"  >
           <div class="col-md-9" style="position: absolute;top:10px; left: 0px;">
                 ...
                 <div  style=" width:812px; padding-left:50px;color:#000000;">
                    ...
                    <div  style="position: absolute;top: 437px; right: -64px; width:268px;color:#000000;">
                       ...
                       <div  >
        <div > 
                    <div  style="position: absolute;top: 583px; left: 67px; width:578px;  color:#000000;">
                       
                       <table style="width:100%; color:#000000; line-height:28px;">
                            <asp:Repeater ID="rptr" runat="server" >
    <ItemTemplate>
                           <tr>
                               <td style="width:64%"> <b> <%#Eval("subject") %> </b></td>
                                 <td style="width:22%"><center><b><%#Eval("maxmarks") %> </b></center> </td>
                                 <td style="float:right"><b><%#Eval("objmarks") %> </b></td>
                           </tr>
                    ...
                    <div  style="width:200px; position: absolute; top: 615px; left:740px; color:#000000;">
                       
                        <b>Total : <%=totalobtmarks %>/<%=totalmaxmark %></b><br /><br />
                ...
                <div >
                 <div  style=" position: absolute; top: 1049px; left:530px; color:#000000;">
                  <%-- <b style="font-style:italic"><%=website %></b>--%>
                      <b style="font-style:italic; font-size:25px">www.sitmup.in</b>
                     </div>
                  ...
                  <%-- <b style="font-style:italic"><%=website %></b>--%>
                      <b style="font-size:23px">ATC :- <%=centre_name %> (<%=centre_code %>)</b>
                        ...
                        <div  style=" position: absolute; top: 1182px; left:427px; color:#000000;">
                           <img src='https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=http://sitmup.in/marksheet_details.aspx?application_no=<%=regno %>'  width="100px" height="100px"/><br /><br />
