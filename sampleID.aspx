<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sampleID.aspx.cs" Inherits="sampleID" %>
     ...
     <uc1:menu runat="server" ID="menu" />
      ...
      <div class="container">
        <div class="page-title clearfix">
            <div class="row">
                <div class="col-md-12">
                    <h6><a href="Default.html">Home</a></h6>
                    <h6><a href="#">SITM</a></h6>
                    <h6><span class="page-active">Identity Card Sample</span></h6>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="col-md-12">
                        <div class="blog-post-container">
                            ...
                            <div class="blog-post-inner">
                                <h3 class="blog-post-title">Identity Card Sample</h3>
                                <p><img src="images/idcard.jpg" /></p>
