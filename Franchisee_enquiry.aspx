<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Franchisee_enquiry.aspx.cs" Inherits="Franchisee_enquiry" %>
            ...
            <div class="row">
                <div class="col-md-12">
                   ...
                   <h6><a href="#">Study Centre</a></h6>
                    <h6><span class="page-active">Franchisee Enquiry</span></h6>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="request-info clearfix"> 
                            ...
                            <div class="full-row">
                                <label for="yourname">Query:</label>
                              
                                 <textarea type="text" id="Query" name="Query"  rows="6"></textarea>
                            </div> <!-- /.full-row -->
