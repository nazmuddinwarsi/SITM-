<%@ Page Language="C#" AutoEventWireup="true" CodeFile="certificate_details.aspx.cs" Inherits="certificate_details" %>
                ...
                <div class="row">
                    <div class="col-md-12">
                       ...
                       <div style="padding-top:345px; ">
                          ...
                          <center><label  style="color:#000; padding-left:32px; font-size:16px;"><%=name %>	</label></center> 
                             <center><label  style="color:#000; padding-left:32px; font-size:16px;"><%=father %>	</label></center> 

                       </div>
                        
                                  
                          <div  style="padding-top:65px; padding-left:52px; font-size:14px; font-weight:bold;">
                                <center><label  style="color:#000; font-size:16px;"><%=course %>	</label></center> 
                         <%--  <table>
                            ...
                            <center> <p class="full-row" style="padding-top:20px;padding-left:122px; line-height:1; font-family:Andalus; color:#000;">
                                <%=center %>
                              </p>
                                </center>  
                                 <center> <p class="full-row" style="padding-top:12px;padding-left:142px; font-size:24px; line-height:1; color:#000;">
                                <%=center_code %>
                              </p>
                                </center>  
